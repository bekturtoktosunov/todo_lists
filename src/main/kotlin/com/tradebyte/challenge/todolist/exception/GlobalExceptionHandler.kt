...
class GlobalExceptionHandler(
    ...
    fun handleIllegalState(exception: IllegalStateException): ProblemDetail = problemDetail(
    ...
    fun handleTodoItemNotFound(exception: TodoItemNotFoundException): ProblemDetail = problemDetail(
    ...
    fun handleOptimisticLock(): ProblemDetail = problemDetail(
    ...
    fun handleTodoItemNotModifiable(exception: TodoItemNotModifiableException): ProblemDetail = problemDetail(
        status = HttpStatus.CONFLICT,
        title = "Conflict",
    ...
    fun handleInvalidTodoStatusTransition(exception: InvalidTodoStatusTransitionException): ProblemDetail = problemDetail(
        status = HttpStatus.CONFLICT,
        title = "Conflict",
    ...
    fun handleMessageNotReadable(): ProblemDetail = problemDetail(
        status = HttpStatus.BAD_REQUEST,
        title = "Bad Request",
    ...
    fun handleInvalidRequestParameter(exception: MethodArgumentTypeMismatchException): ProblemDetail = problemDetail(
        status = HttpStatus.BAD_REQUEST,
        title = "Bad Request",
